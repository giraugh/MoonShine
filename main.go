...
func main() {
	...
	flag.StringVar(&extension, "extension", ".shine", "Extension to look for")
	flag.StringVar(&outextension, "out", ".moon", "Extension to replace with")
	flag.Parse()
...
func compile(path string) {
	...
	//translate to moonscript
	translated, _ := moonshine.Translate(contents)
